...
/**
 * An AWS Lambda function which executes src/submission-forwarder/lambda/forwarder.
 */
export class ForwarderFunction extends lambda.Function {
  constructor(scope: Construct, id: string, props?: ForwarderFunctionProps) {
    super(scope, id, {
      description: 'src/submission-forwarder/lambda/forwarder.lambda.ts',
      ...props,
      runtime: new lambda.Runtime('nodejs20.x', lambda.RuntimeFamily.NODEJS),
      handler: 'index.handler',
      code: lambda.Code.fromAsset(path.join(__dirname, '../../../assets/submission-forwarder/lambda/forwarder.lambda')),
    });
