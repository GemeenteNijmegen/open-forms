...
/**
 * An AWS Lambda function which executes src/prefill-demo/handler.
 */
export class HandlerFunction extends lambda.Function {
  constructor(scope: Construct, id: string, props?: HandlerFunctionProps) {
    super(scope, id, {
      description: 'src/prefill-demo/handler.lambda.ts',
      ...props,
      runtime: new lambda.Runtime('nodejs22.x', lambda.RuntimeFamily.NODEJS),
      handler: 'index.handler',
      code: lambda.Code.fromAsset(path.join(__dirname, '../../assets/prefill-demo/handler.lambda')),
    });
